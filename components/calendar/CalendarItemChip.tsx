...
export function CalendarItemChip({
  ...
  if (item.kind === "task") {
    return (
      <Link
        href="/board"
        className={cn(
          "block truncate rounded-md bg-surface px-1.5 py-0.5 text-[11px] font-medium text-text transition-colors hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-accent",
        )}
        aria-label={label}
        title={item.title}
      >
  ...
  return (
    <button
      ...
      className={cn(
        "block w-full truncate rounded-md px-1.5 py-0.5 text-left text-[11px] font-medium text-accent-foreground transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-accent",
